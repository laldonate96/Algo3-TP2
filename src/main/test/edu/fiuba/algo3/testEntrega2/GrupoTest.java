...
public class GrupoTest {
    ...
    @Test
    public void test05AceptaVisitaDeUnaOpcionGrupoConElMismoGrupoYDevuelveTrue(){
        //Arrange
        Grupo opcionVisitor = new Grupo("Opcion 1", "Grupo 1", new Correcta());
        //Assert
        assertTrue(opcionCorrecta.aceptar(opcionVisitor));
    }

    @Test
    public void test06AceptaVisitaDeUnaOpcionGrupoConDistintoGrupoYDevuelveFalse(){
        //Arrange
        Grupo opcionVisitor = new Grupo("Opcion 1", "Grupo 7", new Correcta());
        //Assert
        assertFalse(opcionCorrecta.aceptar(opcionVisitor));
    }

    @Test
    public void test07VisitaAUnaOpcionGrupoConElMismoGrupoYDevuelveTrue(){
        //Arrange
        Grupo opcionCorrecta2 = new Grupo("Opcion 1", "Grupo 1", new Correcta());
        //Assert
        assertTrue(opcionCorrecta.visitar(opcionCorrecta2));
    }

    @Test
    public void test08VisitaAUnaOpcionGrupoConDistintoTextoYDevuelveFalse(){
        //Arrange
        Grupo opcionDistintoTexto = new Grupo("Opcion 12", "Grupo 1", new Correcta());
        //Assert
