...
public class GroupChoiceTest {
    ...
    public void setUp() {
        ...
        opcion1Incorrecta = new Group("Opcion 1", grupo1, new Incorrecta());
        opcion2Incorrecta = new Group("Opcion 2", grupo2, new Incorrecta());
        opcion3Incorrecta = new Group("Opcion 3", grupo3, new Incorrecta());
