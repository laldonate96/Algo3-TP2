...
public class OrderedChoiceTest {
    ...
    public void setUp() {
        ...
        opcion1Incorrecta = new Opcion("Opcion 1","3");
        opcion2Incorrecta = new Opcion("Opcion 2","4");
        opcion1 = new Opcion("Opcion 1","2", new Correcta());
        opcion2 = new Opcion("Opcion 2","3", new Correcta());
