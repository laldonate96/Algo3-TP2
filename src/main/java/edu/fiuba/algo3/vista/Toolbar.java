...
public class Toolbar { 
	...
	{ 
        ...
        button2.getItems().addAll(item1, item2, item3, item4, item5, sliderMenuItem);
        MenuButton button3 = new MenuButton("Ver");
        MenuItem item6 = new MenuItem("Acerca De");
        item6.setOnAction(e -> controladorPantalla.mostrarVentana(acercaDe));
        MenuItem item7 = new MenuItem("Reglas");
        item7.setOnAction(e -> controladorPantalla.mostrarVentana(reglas));
        button3.getItems().addAll(item6, item7);
