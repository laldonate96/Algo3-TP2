...
public class PreguntaMultipleChoicePenalizable implements Pregunta {
    private String enunciado;
    private List<String> respuestaCorrecta;
    private int puntos;

    public PreguntaMultipleChoicePenalizable(String enunciado, List<String> respuestaCorrecta) {
